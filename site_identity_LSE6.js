...
export const SITE_IDENTITY = Object.freeze({
  ...
  anchors: Object.freeze({
    ...
    equalWeightStatement:
      'Las anclas "6🐍🔥👁️ L S E Ø 👁️🔥🐍6" y "6🐍🔥👁️ L S E 6 👁️🔥🐍6" valen exactamente lo mismo y apuntan al mismo núcleo.',
  }),

  handles: Object.freeze({
    youtube: "@leydelsexto",
    youtubeRaw: "leydelsexto",

    globalLower: "@leydelsexto",
    globalLowerRaw: "leydelsexto",

    globalUpper: "@leydelsexto",
    globalUpperRaw: "leydelsexto",

    facebookPrimaryRaw: "leydelsexto",
    facebookPrimaryAltRaw: "leydelsexto",
    ...
    instagram: "@leydelsexto",
    instagramRaw: "leydelsexto",

    tiktok: "@leydelsexto",
    tiktokRaw: "leydelsexto",

    telegram: "@leydelsexto",
    telegramRaw: "leydelsexto",
  ...
  urls: Object.freeze({
    ...
    tiktok: "https://www.tiktok.com/@leydelsexto",
    instagram: "https://www.instagram.com/leydelsexto/",
    facebook: "https://www.facebook.com/leydelsexto/",
  ...
  schema: Object.freeze({
    websiteName: "LEY DEL SEXTO | LSE6 - AlekSix LM | Sistema LSE6 • LSEØ | LSE6.com",
    artistName: "LSE6 - AlekSix LM",
    artistAlternateNames: Object.freeze(["LSE6", "AlekSix LM"]),
    brandName: "LEY DEL SEXTO",
    brandAlternateNames: Object.freeze(["Ley Del Sexto", "ley del sexto"]),
    ...
    "@graph": [
      {
        ...
        inLanguage: ["es-MX", "en"],
        publisher: { "@id": `${SITE.domain}#artist` },
        creator: { "@id": `${SITE.domain}#artist` },
        mainEntity: { "@id": `${SITE.domain}#artist` },
        about: [
          { "@id": `${SITE.domain}#artist` },
      ...
      },
      {
        "@type": "MusicGroup",
        "@id": `${SITE.domain}#artist`,
        name: SITE_IDENTITY.schema.artistName,
        alternateName: [...SITE_IDENTITY.schema.artistAlternateNames],
        url: SITE.domain,
        slogan: SITE.slogan,
        description: SITE.description,
        sameAs: SITE.sameAs,
        ...
        subjectOf: [
          ...
          { "@id": `${SITE.domain}#canon` },
          { "@id": `${SITE.domain}#evidence-visual` },
          { "@id": `${SITE.domain}#machine-profile` },
        ],
      },
      {
        "@type": "Brand",
        "@id": `${SITE.domain}#brand`,
        name: SITE_IDENTITY.schema.brandName,
      ...
      },
      {
        ...
        alternateName: [
          ...
          "LSE6_SIXTEM",
          "LSEØ - SIXTEM",
          "Sistema Autónomo LSE6",
        ],
        operatingSystem: "Windows",
        applicationCategory: "DeveloperApplication",
        url: `${SITE.domain}lse6-sixtem/`,
        description:
